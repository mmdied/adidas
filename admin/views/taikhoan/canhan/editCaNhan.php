...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Quản lí tài khoản cá nhân </h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
	...
	<div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center">
          <img src="<?= BASE_URL . $thongTin["anh_dai_dien"]; ?>" style = "width: 150px"  class="avatar img-circle" alt="avatar" onerror="this.onerror=null; this.src='https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png'">
